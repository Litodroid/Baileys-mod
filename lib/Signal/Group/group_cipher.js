...
export class GroupCipher {
    ...
    async getPlainText(iv, key, ciphertext) {
        try {
            return this.decryptAesCbc(key, ciphertext, iv);
        }
        catch (e) {
    ...
    async getCipherText(iv, key, plaintext) {
        try {
            ...
            return this.encryptAesCbc(keyBuffer, plaintextBuffer, ivBuffer);
        }
        catch (e) {
            throw new Error('InvalidMessageException');
        }
    ...
    // Implementación de decrypt usando crypto de Node.js
    decryptAesCbc(key, ciphertext, iv) {
    ...
    // Implementación de encrypt usando crypto de Node.js
    encryptAesCbc(key, plaintext, iv) {
