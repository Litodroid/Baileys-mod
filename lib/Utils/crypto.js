import { createCipheriv, createDecipheriv, createHash, createHmac, randomBytes, generateKeyPairSync, createECDH } from 'crypto';
/* @ts-ignore */
...
export const Curve = {
    ...
    verify: (pubKey, message, signature) => {
        ...
        try {
            ...
            return verify.verify(generateSignalPubKey(pubKey), signature);
        } catch (error) {
            return false;
        }
    }
