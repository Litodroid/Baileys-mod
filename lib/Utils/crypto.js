...
export const Curve = {
    ...
    sign: (privateKey, buf) => {
        ...
        try {
            ...
            // Usar la clave privada directamente como Buffer
    ...
    verify: (pubKey, message, signature) => {
        ...
        try {
            ...
            // Usar la clave pública directamente como Buffer
            ...
            try {
                ...
                const expectedSignature = createHmac('sha256', publicKey).update(message).digest();
